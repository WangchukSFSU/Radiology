...
<script>
     ...
     jq('#orderDetailDiv #reportCancelId').next().attr('id', 'reportCancelIcon');
     jq('#orderDetailDiv #reportCancelId').next().addClass("order");
     jq('#orderDetailDiv #reportCancelId').attr('onclick', onclick = "cancelReport(); return false;");
     }
