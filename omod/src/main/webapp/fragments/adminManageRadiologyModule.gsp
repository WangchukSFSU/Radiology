...
<script>
    ...
    // var SelectedFile = inputvalue.match(/^[/][a-zA-Z]+[/]+\$/);
    var SelectedFile = inputvalue.match(/^(.+)[/]([^/]+)\$/);
    ...
    jq.getJSON('${ ui.actionLink("updateModalityIP") }', {
     ...
     function checkForModalitySoftware() {
     ...
     <table id="modalityTable" class="ss">
          <thead>
               <tr>
                    ...
                    <th class="modsoftware">IP Address</th>
                    <th class="modsoftware"> Enter IP Address</th>
                    <th class="modsoftware">HomePath</th>
                    <th class="modsoftware"> Enter Home Path</th>
               </tr>
          ...
          <tbody>
               ...
               <tr class="item">
                    ...
                    <td class="modsoftware"><input type = "text" class = "modIPInput" id = ' ${mod.modalityName} ' /><span id="modFolderIPSpan" class="modFolderIPSpan"> </span></</td>

                    <td class = "rootPath" id = ' ${mod.modalityName} '> ${mod.modalityPath} </td>
                    <td class="modsoftware"><input type = "text" class = "modFolderInput" id = ' ${mod.modalityName} ' /><span id="modFolderInputSpan" class="modFolderInputSpan"> </span></</td>
               </tr>
               <% } %> 
               ...
               <tr class="item">
                    ...
                    <td class="modsoftware"><input type = "text" class = "modIPInput" id = ' ${modAB} ' /><span id="modFolderIPSpan" class="modFolderIPSpan"> </span></</td>

                    <td class = "rootPath" id = ' ${modAB} '>  </td>
                    <td class="modsoftware"><input type = "text" class = "modFolderInput" id = ' ${modAB} ' /><span id="modFolderInputSpan" class="modFolderInputSpan"> </span></</td>
               </tr>
               <% } %> 
          </tbody>
     </table>
