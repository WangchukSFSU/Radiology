...
public class AddEditObservationFragmentController extends BaseHtmlFormFragmentController {
	...
	/**
	 * If report is entered, get the report saved encounterId generated by the HTMLFormEntryUI for the order
	 ...
	 * @param service ConceptService
	 * @param model FragmentModel
	 * @param radiologyorderId order having HTMLFormEntryUI report saved encounterId
	 * @param ui
	 ...
	 * @param service ConceptService
	 * @param model FragmentModel
	 * @param radiologyorderId order that has the saved HTMLFormEntryUI encounterId
	 * @param ui UiUtils
	 ...
	 * @param service ConceptService
	 * @param model
	 * @param radiologyorderId order to get the HTMLFormEntryui report templates
	...
	/**
	 * Once report is submitted, update the active orders. Order submitted is no longer available in the active order
	 * list
	 ...
	 * This is from the HTMLFormEntryui module
	 * 
	 * @param sessionContext
	 * @param patient
	 * @param hf HTMLForm
